            ...
            <div class="moga-single-content">
                ...
                <div class="moga-property-highlights">
                    <div class="moga-property-highlights__item">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                    ...
                    <?php if ( $difficulty_data ) : ?>
                        <div class="moga-property-highlights__item">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="<?php echo esc_attr( $difficulty_data['color'] ); ?>" stroke-width="1.5" aria-hidden="true"><path d="M13 2L3 14h7l-1 8 11-14h-7l1-6z"/></svg>
                    ...
                    <?php if ( $language ) : ?>
                        <div class="moga-property-highlights__item">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
                ...
                <div class="moga-booking-sidebar" id="moga-booking-sidebar">
                    ...
                    <?php if ( $organizer_name ) : ?>
                        <div class="moga-organizer-card">
                            ...
                            <?php if ( $organizer_whatsapp ) : ?>
                                <a href="<?php echo esc_url( 'https://wa.me/' . preg_replace( '/\D/', '', $organizer_whatsapp ) ); ?>" class="moga-organizer-card__whatsapp" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e( 'Chat on WhatsApp', 'moga-travel' ); ?>">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.6 6.3a8.9 8.9 0 0 0-14.2 10.7L2 22l5.2-1.4A8.9 8.9 0 0 0 17.6 6.3zM12 20.2a7.3 7.3 0 0 1-3.7-1l-.3-.2-2.7.7.7-2.6-.2-.3a7.3 7.3 0 1 1 13.6-3.7 7.3 7.3 0 0 1-7.4 7.1zm4-5.5c-.2-.1-1.3-.6-1.5-.7-.2-.1-.3-.1-.5.1s-.6.7-.7.8-.3.2-.5.1a6 6 0 0 1-1.8-1.1 6.7 6.7 0 0 1-1.2-1.5c-.1-.2 0-.3.1-.5l.4-.4c.1-.1.1-.2.2-.4s0-.3 0-.4l-.7-1.6c-.2-.4-.4-.4-.5-.4h-.5a.9.9 0 0 0-.6.3 2.7 2.7 0 0 0-.8 2 4.7 4.7 0 0 0 1 2.5 10.7 10.7 0 0 0 4.1 3.6c.6.2 1 .4 1.4.5a3.3 3.3 0 0 0 1.5.1 2.5 2.5 0 0 0 1.6-1.1 1.9 1.9 0 0 0 .1-1.1c-.1-.1-.2-.2-.4-.3z"/></svg>
                                </a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
