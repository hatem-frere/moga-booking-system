 ...
 * Tour Card — Grid View
 *
 * Displays a single tour in grid layout.
 * Used on: homepage featured tours, search results (grid mode).
 *
 * @package    MogaTravel
 * @since      1.0.0
 */
...
<article class="moga-card moga-card--grid moga-tour-card" data-id="<?php echo esc_attr( $tour_id ); ?>">
