...
class Moga_Shortcode_Account {
    ...
    private function render_dob_selects() {
        ...
        $months = array(
            1 => __( 'January', 'moga-travel' ), 2 => __( 'February', 'moga-travel' ), 3 => __( 'March', 'moga-travel' ),
            4 => __( 'April', 'moga-travel' ), 5 => __( 'May', 'moga-travel' ), 6 => __( 'June', 'moga-travel' ),
            7 => __( 'July', 'moga-travel' ), 8 => __( 'August', 'moga-travel' ), 9 => __( 'September', 'moga-travel' ),
            10 => __( 'October', 'moga-travel' ), 11 => __( 'November', 'moga-travel' ), 12 => __( 'December', 'moga-travel' ),
        );
    ...
    private function render_register_form( $type, $error ) {
        ...
        ( function() {
            ...
            entityInputs.forEach( function( el ) { el.addEventListener( 'change', sync ); } );
            sync();
        } )();
        </script>
        <?php endif; ?>
        ...
        ( function() {
            ...
            function checkMatch() {
                if ( ! confirmField.value ) { matchHint.hidden = true; return; }
            ...
            passField.addEventListener( 'input', function() { checkPassword(); checkMatch(); } );
    ...
    private function handle_profile_update( $user_id ) {
        ...
        if ( $is_vendor ) {
            $entity_type = isset( $_POST['moga_entity_type'] ) ? sanitize_text_field( wp_unslash( $_POST['moga_entity_type'] ) ) : 'individual';
            update_user_meta( $user_id, 'moga_entity_type', $entity_type );
            update_user_meta( $user_id, 'moga_company_name',
