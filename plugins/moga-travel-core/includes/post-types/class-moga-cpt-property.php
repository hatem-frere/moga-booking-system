...
class Moga_CPT_Property
{
    ...
    public static function register()
    {
        ...
        $args = array(
            ...
            // Capabilities.
            // BUG FIX (Aug 15 session): was 'post' — the generic
            // built-in Post capability set. moga_property_owner
            // (class-moga-roles.php) was never granted any generic
            // Post capabilities, only the custom moga_* ones (e.g.
            // edit_moga_property, publish_moga_propertys) — meaning
            // property owners could not create, edit, or publish a
            // single listing until this matched. map_meta_cap was
            // already correctly set to true.
            'capability_type'     => array('moga_property', 'moga_propertys'),
            'map_meta_cap'        => true,
